...
import FeeReceivedData from "../FeeReceivedData.js";
import { BiFilter } from "react-icons/bi";
import ScheduleData from "../ScheduleData.js";
import RandomStudentsData from "../RandomStudentsData.js";
    ...
    <div className="container ">
      <div className="main-cards mb-0">
        <div className="card bg-gray-100 px-1 py-1">
          <div className="card-inner text-black flex ">
            <div>
      ...
      {/* Schedule */}
      <div className="flex justify-between items-center text-black  bg-gray-100 px-4 py-2 mt-1">
        <h4>Upcoming Schedule</h4>
        <div className="flex items-center space-x-2">
          <button
            className="py-0 px-8 bg-gray-300 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 hover:bg-gray-700 hover:text-white"
          ...
          <BiFilter className="text-gray-400 hover:text-gray-700 cursor-pointer" />
        </div>
      </div>
